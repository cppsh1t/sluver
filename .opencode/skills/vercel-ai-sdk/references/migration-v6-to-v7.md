...
- [Prompts and Steps](#prompts-and-steps)
- [Lifecycle Callbacks](#lifecycle-callbacks)
- [Usage, Telemetry, and Include Options](#usage-telemetry-and-include-options)
- [Streaming, Messages, and Tools](#streaming-messages-and-tools)
- [Content Parts and Reasoning](#content-parts-and-reasoning)
- [Multi-Step Result Shape](#multi-step-result-shape)
- [Stream Response Helpers](#stream-response-helpers)
- [Package-Specific Checks](#package-specific-checks)
- [Validation](#validation)

## Source of Truth

Use `content/docs/08-migration-guides/23-migration-guide-7-0.mdx` from the AI SDK repo as the source of truth. This file is the working checklist; read the guide for exact examples or when behavior is unclear.
