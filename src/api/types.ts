...
type SceneFields = Pick<Scene, 'title' | 'summary' | 'content' | 'writingRequirements' | 'wordCountRequirements' | 'startAt' | 'endAt' | 'characterRefs' | 'locationId' | 'itemIds' | 'eventIds' | 'loreIds'>;
