...
const createSceneSchema = z.object({
  ...
  startAt: z.string().optional().describe("ISO 8601 timestamp for when the scene starts."),
  endAt: z.string().optional().describe("ISO 8601 timestamp for when the scene ends."),
