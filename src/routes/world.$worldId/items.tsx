...
import { Add01Icon, Package02Icon, Search01Icon } from "@hugeicons/core-free-icons";
...
function ItemsPage() {
  ...
  async function handleUpdate(id: string, input: UpdateElementInput) {
    try {
      await updateMut.mutateAsync({ id: id as Item["id"], input });
  ...
  async function handleDelete(id: string) {
    try {
      await deleteMut.mutateAsync(id as Item["id"]);
